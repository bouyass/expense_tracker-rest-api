...
public class CategoryRepositoryImpl implements  CategoryRepository {
    ...
    @Override
    public List<Category> findAll(Integer userId) throws EtBadRequest {
        try {
    ...
    @Override
    public Integer create(Integer userId, String title, String description) throws EtBadRequest {
        try {
    ...
    @Override
    public void update(Integer userId, Integer categoryId, Category category) throws EtBadRequest {
        try {
